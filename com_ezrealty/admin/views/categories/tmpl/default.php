	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				...
				<th width="13%" class="nowrap hidden-phone">
					<?php echo JHTML::_( 'grid.sort', JText::_('COM_EZREALTY_ACCESS'), 'groupname', $listDirn, $listOrder); ?>
				</th>
		...
		<tbody>
			...
			for ($i=0, $n=count( $items ); $i < $n; $i++) {
				...
				$row->id 	= $row->id;
				$link 		= 'index.php?option=com_ezrealty&controller=categories&task=edit&hidemainmenu=1&cid='. $row->id;
