...
foreach ($this->items as $item) {
    ...
    $shortlist = JURI::root() . 'index.php?tmpl=component&amp;option=com_ezrealty&amp;task=addshortlist&amp;id='. $item->id;
		...
		<div class="row-fluid">
			...
			<?php } ?>
				...
				<?php if ( $this->params->get( 'show_openhousedate' ) ) {
					if ($item->ohdate >= $getnow && $item->ohdate != '0000-00-00' && $item->ohdate && $item->ohdate != '00:00:00' || $item->ohdate2 >= $getnow && $item->ohdate2 != '0000-00-00' && $item->ohdate && $item->ohstarttime2 != '00:00:00' ) { ?>
						<div class="row-fluid ezitem-toppad">
							<div class="span12">
