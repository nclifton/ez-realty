...
if ($this->state->declat && $this->state->declong){
	$latitude = $this->state->declat;
	$longitude = $this->state->declong;
	$mapres = $this->params->get( 'state_resolution');
} else {
...
$maploc  = intval(JRequest::getVar( 'filter_a4locality', '0'));
...
<?php
  ...
  function initEzrMapCom() {
	...
	var mapOptions = {
		center: centerPlace,
		zoom: <?php echo $this->params->get( 'state_resolution');?>,
