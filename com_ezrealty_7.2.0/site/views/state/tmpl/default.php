...
<div id="system" class="container-fluid">
	...
	<?php if ( $this->params->get( 'show_page_heading' ) || $this->params->get('show_state_title') ) { ?>
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<?php if($this->params->get('show_state_title') && $this->state->name) { ?>
					<h2>
						<span>
							<?php echo JHtml::_('content.prepare', $this->state->name); ?>
						</span>
					</h2>
				<?php } ?>
...
<br />
	...
	<div class="row-fluid ezitem-bigtopmargin">

		<div class="span12">
			<?php echo $this->loadTemplate('suburbs'); ?>
		</div>
